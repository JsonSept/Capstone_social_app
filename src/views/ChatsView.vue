<template>
    ...
    <nav class="navbar2 fixed-bottom bg-body-purple">
        <div class="container-fluid">
         
         <router-link-exact-active to="./ChatsView.vue"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" id="icon" class="bi bi-chat-quote-fill bg-purple" viewBox="0 0 16 16">
...
</svg></router-link-exact-active>
<<router-link to="./post">
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" id="icon" class="bi bi-boxes" viewBox="0 0 16 16">
...
<router-link to="./Calls">
    <svg  xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" id="icon" class="bi bi-telephone-x-fill" viewBox="0 0 16 16">
